...
class AppStateModel extends foundation.ChangeNotifier {
  ...
  //切换主题模式
  CupertinoThemeData _themeData = Styles.DayTheme;
  ...
  void changeTheme() {
    //  _themeData ?CupertinoThemeData(brightness: Brightness.light):CupertinoThemeData(brightness: Brightness.dark);
    if (_themeData == Styles.DayTheme) {
      _themeData = Styles.NightTheme;
    } else {
      _themeData = Styles.DayTheme;
    }
    notifyListeners();
  }
